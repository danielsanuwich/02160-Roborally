...
public class MakeGameBoardLayout1 {
    ...
    public GameBoard gb() {
        ...
        gb.setTile(new Position(8, 0), new HoleTile(new Position(8, 0)));
        gb.setTile(new Position(9, 0), new HoleTile(new Position(9, 0)));
        gb.setTile(new Position(10, 0), new HoleTile(new Position(10, 0)));

        gb.setTile(new Position(0, 1), new HoleTile(new Position(0, 1)));
        gb.setTile(new Position(1, 1), new FlagTile(new Position(1, 1)));
        gb.setTile(new Position(2, 1), new Tile(new Position(2, 1)));
        gb.setTile(new Position(3, 1), new Tile(new Position(3, 1)));
        gb.setTile(new Position(4, 1), new TurnTile(new Position(4, 1), -1));
        ...
        gb.setTile(new Position(7, 1), new Tile(new Position(7, 1)));
        gb.setTile(new Position(8, 1), new Tile(new Position(8, 1)));
        gb.setTile(new Position(9, 1), new FlagTile(new Position(9, 1)));
        gb.setTile(new Position(10, 1), new HoleTile(new Position(10, 1)));
        ...
        gb.setTile(new Position(5, 2), new Tile(new Position(5, 2)));
        gb.setTile(new Position(6, 2), new StartTile(new Position(6, 2)));
        ...
        gb.setTile(new Position(10, 2), new HoleTile(new Position(10, 2)));
        ...
        gb.setTile(new Position(2, 3), new Tile(new Position(2, 3)));
        gb.setTile(new Position(3, 3), new TurnTile(new Position(3, 3), -1));
        gb.setTile(new Position(4, 3), new HoleTile(new Position(4, 3)));
        ...
        gb.setTile(new Position(7, 3), new Tile(new Position(7, 3)));
        ...
        gb.setTile(new Position(10, 3), new HoleTile(new Position(10, 3)));

        gb.setTile(new Position(0, 4), new HoleTile(new Position(0, 4)));
        gb.setTile(new Position(1, 4), new TurnTile(new Position(1, 4), 1));
        gb.setTile(new Position(2, 4), new Tile(new Position(2, 4)));
        gb.setTile(new Position(3, 4), new StartTile(new Position(3, 4)));
        gb.setTile(new Position(4, 4), new HoleTile(new Position(4, 4)));
        gb.setTile(new Position(5, 4), new HoleTile(new Position(5, 4)));
        gb.setTile(new Position(6, 4), new Tile(new Position(6, 4)));
        ...
        gb.setTile(new Position(10, 4), new HoleTile(new Position(10, 4)));
        ...
        gb.setTile(new Position(6, 5), new TurnTile(new Position(6, 5), -1));
        gb.setTile(new Position(7, 5), new StartTile(new Position(7, 5)));
        gb.setTile(new Position(8, 5), new TurnTile(new Position(8, 5), 1));
        gb.setTile(new Position(9, 5), new LaserTile(new Position(9, 5), new Direction(2), 1));
        gb.setTile(new Position(10, 5), new HoleTile(new Position(10, 5)));
        ...
        gb.setTile(new Position(8, 6), new Tile(new Position(8, 6)));
        gb.setTile(new Position(9, 6), new Tile(new Position(9, 6)));
        gb.setTile(new Position(10, 6), new HoleTile(new Position(10, 6)));
        ...
        gb.setTile(new Position(8, 7), new HoleTile(new Position(8, 7)));
        gb.setTile(new Position(9, 7), new HoleTile(new Position(9, 7)));
        gb.setTile(new Position(10, 7), new HoleTile(new Position(10, 7)));
