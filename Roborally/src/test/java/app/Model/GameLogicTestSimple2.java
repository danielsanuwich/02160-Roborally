...
public class GameLogicTestSimple2 {
    ...
    @BeforeEach
    void setUp() {
        initialPos1 = new Position(3, 3);
        initialPos2 = new Position(6, 5);
        ...
        MakeGameBoardLayout3 mgbl = new MakeGameBoardLayout3();
    ...
    void testHole() {
        ...
        Direction direction2 = new Direction(1);
        robot2.setDirection(direction2);
        ProgramCard card2 = new ProgramCard(0, 1);
        Direction expectedDirection2 = robot2.getDirection();
        Position expectedPosition2 = new Position(6, 6);
        int expectedHealth2 = 9;

        gameLogic.ExecuteTurn(card2, robot2, board);

        assertEquals(expectedDirection2, robot2.getDirection());
    ...
    @Test
    void testLaser() {
        Position Position1 = new Position(6,3);
        robot1.setPosition(Position1);
    ...
    void testTurn() {
        ...
        robot1.setDirection(direction1);
        ProgramCard card = new ProgramCard(0, 1);
        Direction expectedDirection = new Direction(3);
        ...
        Position Position2 = new Position(4,6);
        robot2.setPosition(Position2);
        //Direction direction2 = new Direction(5);
        //robot2.setDirection(direction2);
        ProgramCard card2 = new ProgramCard(0, 1);
        Direction expectedDirection2 = new Direction(1);
        Position expectedPosition2 = new Position(4, 5);
