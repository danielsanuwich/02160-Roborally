...
public class GameLogicTestSimple {
    ...
    @BeforeEach
    void setUp() {
        initialPos1 = new Position(4, 3);
        initialPos2 = new Position(4, 2);
        ...
        MakeGameBoardLayout2 mgbl = new MakeGameBoardLayout2();
    ...
    @Test
    void testHole() {
        Position Position1 = new Position(6,5);
        robot1.setPosition(Position1);
        Direction direction1 = new Direction(1);
        robot1.setDirection(direction1);
        ProgramCard card = new ProgramCard(0, 1);
    ...
    void testTurn() {
        ...
        robot1.setDirection(direction1);
        ProgramCard card = new ProgramCard(0, 1);
        Direction expectedDirection = new Direction(4);
        ...
        Position expectedPosition2 = new Position(2, 3);
