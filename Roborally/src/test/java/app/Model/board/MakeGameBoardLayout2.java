...
public class MakeGameBoardLayout2 {
    public GameBoard makeBoard(){
        GameBoard gb = new GameBoard(8,8); // x and y correct order?
            ...
            gb.setTile(new Position(6,1),new Tile("Base", new Position(6, 1), new Direction(0)));
            ...
            gb.setTile(new Position(1,2),new Tile("Base", new Position(1, 2), new Direction(0)));
            gb.setTile(new Position(2,2),new Tile("Base", new Position(2, 2), new Direction(0)));
            gb.setTile(new Position(3,2),new Tile("Base", new Position(3, 2), new Direction(0)));
            gb.setTile(new Position(4,2),new Tile("Base", new Position(4, 2), new Direction(0)));
            gb.setTile(new Position(5,2),new ConveyorTile(new Position(5, 2), new Direction(0)));
            gb.setTile(new Position(6,2),new Tile("Base", new Position(6, 2), new Direction(0)));
            ...
            gb.setTile(new Position(3,3),new HoleTile(new Position(3, 3), new Direction(0), 1));
            gb.setTile(new Position(4,3),new Tile("Base", new Position(4, 3), new Direction(0)));
            ...
            gb.setTile(new Position(1,4),new Tile("Base", new Position(1, 4), new Direction(0)));
            gb.setTile(new Position(2,4),new Tile("Base", new Position(2, 4), new Direction(0)));
            gb.setTile(new Position(3,4),new Tile("Base", new Position(3, 4), new Direction(0)));
            ...
            gb.setTile(new Position(2,5),new HoleTile(new Position(2, 5), new Direction(0), 1));
            gb.setTile(new Position(3,5),new Tile("Base", new Position(3, 5), new Direction(0)));
            gb.setTile(new Position(4,5),new Tile("Base", new Position(4, 5), new Direction(0)));
            ...
            gb.setTile(new Position(1,6),new Tile("Base", new Position(1, 6), new Direction(0)));
            gb.setTile(new Position(2,6),new Tile("Base", new Position(2, 6), new Direction(0)));
            ...
            gb.setTile(new Position(5,6),new StartTile(new Position(5, 6), new Direction(0)));
